...
@section('content')
    @php($domains = old('domains', ['']))

    <div class="container-fluid">
        <div class="mb-4">
            {{-- <p class="text-primary fw-semibold mb-1">Super Admin</p> --}}
            <h1 class="page-title mb-1">Add user</h1>
            <p class="text-secondary mb-0">Create a new user account and assign their domains.</p>
        </div>

        <div class="dashboard-card">
            <form data-user-form method="POST" action="{{ route('super-admin.admin.store') }}">
                @csrf
        ...
        (() => {
            ...
            form.addEventListener('submit', async (event) => {
                ...
                try {
                    ...
                    if (!response.ok) {
                        throw new Error('Unable to create the user. Please try again.');
                    }
